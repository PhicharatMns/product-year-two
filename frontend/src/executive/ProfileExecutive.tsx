        ...
        >
          ...
          >
            <div className="absolute -bottom-20 left-1/2 transform -translate-x-1/2">
              <img
                src="https://yt3.googleusercontent.com/CMqKWgqvz1amDcZaIa7KksykIeM1TjNpyg5mxNrdoRl3UbLVbyX7mGg7CV-hPiQ3Dfp7N2jr6g=s900-c-k-c0x00ffffff-no-rj"
                alt="profile"
          ...
          <div className="flex-1 flex flex-col justify-start mt-24 px-4 sm:px-6 md:px-12 overflow-y-auto">
              ...
              <p className={`mt-1 ${softText}`}>Executive</p>
            </div>
