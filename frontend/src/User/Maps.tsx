      ...
      >
        ...
        >
          ...
          <div className="flex flex-col gap-4">
           ...
           <button className={` text-white inline-flex h-12 items-center justify-center rounded-md bg-blue-500  px-6 font-medium   transition active:scale-95 ${text} ${bgbtn}`}>
           ยืนยัน</button>
          </div>
        </div>
