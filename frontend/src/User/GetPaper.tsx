...
const users: User[] = [
  { id: 1, name: "สร้างสะพานข้างถนน", email: "nobody@gmail.com", phone: "081-111-1111", lastActive: "SEP 01, 2024", dateAdded: "NOV 01, 2025" },
  { id: 2, name: "สร้างหมู่บ้านจัดสรร", email: "nobody@gmail.com", phone: "081-222-2222", lastActive: "SEP 01, 2024", dateAdded: "NOV 01, 2025" },
  { id: 3, name: "โครงการรักบ้านรักโลก", email: "nobody@gmail.com", phone: "081-333-3333", lastActive: "SEP 01, 2024", dateAdded: "NOV 01, 2025" },
  { id: 4, name: "ทำถนนทางหลวง", email: "nobody@gmail.com", phone: "081-444-4444", lastActive: "SEP 01, 2024", dateAdded: "NOV 01, 2025" },
];
      ...
      <div className="w-max-380 p-8 mx-auto container pt-10">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <p className={`text-3xl font-bold ${theme === 'dark' ? 'text-yellow-500' : 'text-blue-500'}`}>
            ใบ<span className={`${theme === 'dark' ? 'text-white' : 'text-yellow-500'}`}>งาน</span>
          </p>
