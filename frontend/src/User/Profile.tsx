...
const DetailItem = ({ Icon, label, value }) => {
  ...
  return (
    <div className="flex items-start space-x-4 py-3">
      <Icon
        className={`w-5 h-5 flex-shrink-0 ${theme === "dark" ? "text-gray-400" : "text-gray-500"
          } mt-1`}
      />
      <div className="flex flex-col overflow-hidden">
        ...
        <span
          className={`text-base font-semibold ${theme === "dark" ? "text-gray-50" : "text-gray-800"
            } break-words`}
        >
          {value}
        </span>
      ...
      >
        ...
        >
          ...
          <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            ...
            {/* คอลัมน์ซ้าย: Contact */}
            <section>
              <h3 className={`text-lg font-semibold ${primaryColor} mb-4 pb-2 border-b ${borderColor}`}>
                Contact Information
              </h3>
              <div className="space-y-2">
                <DetailItem Icon={Mail} label="Email Address" value={email} />
                <DetailItem Icon={Phone} label="Phone Number" value={phones} />
                <DetailItem Icon={MapPin} label="Current Address" value={Address} />
              </div>
            </section>
