...
export default function SuppliesAdmin() {
  ...
  return (
    <div className={`w-max-380 p-4 mx-auto container pt-10`}>
      <div className="p-5">
        <p className={`text-3xl font-bold  ${titleColor}`}>วัสดุอุปกรณ์<span className={`${theme === 'dark' ? 'text-white' : 'text-yellow-500'}`}>Admin</span></p>
              ...
              {[
                ...
                >
                  ...
                  <td className="py-2 px-4 border-b text-center">
                    <button
                      className={`h-9 px-4 rounded-2xl font-medium transition transform hover:scale-105 ${theme === "dark"
