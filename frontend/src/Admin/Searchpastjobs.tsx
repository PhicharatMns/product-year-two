...
export default function Searchpastjobs() {
  ...
  const filtered = data.filter(
    (e) =>
      ...
      (e.Contact_number ?? "").includes(search.toLowerCase()) ||
    ...
    >
      <div className="">
        <div className={``}>
          ...
          {/* Table */}
          <div
            className={`hidden lg:grid font-semibold  text-lg grid-cols-8 gap-5 border-b-2 px-5  mb-3 ${t
            ...
            filtered
              ...
              .map((e, index) => (
                <motion.div
                  ...
                  className={`grid grid-cols-1 lg:grid-cols-8 rounded-lg gap-5 items-center py-1 px-5 mt-2 border ${theme === "dark" ? "bg-gray-900" : "bg-gray-100"
                    }`}
                >
                  {/* ชื่อ คต. */}
                  {(
                  ...
                  <p
                    ...
                    className={`cursor-pointer ${e.Status === "กำลังดำเนินการ" ? texthaed : ""
                  ...
                  {Object.entries({
                    ...
                    <div key={k} className="flex flex-col">
                      ...
                      {k === "address" ? (
                        ...
                        <input
                          type={k === "Contact_number" ? "number" : "text"} // <-- เปลี่ยน type เป็น number
      ...
      <AnimatePresence>
        {openstatus && (
          ...
          >
            ...
            >
              <p
                className={`text-xl font-semibold mb-4 ${theme === "dark" ? "text-yellow-500" : "text-blue-500"
                  }`}
              >
                เหตุผลการขอปิดงาน
              </p>
              ...
              <div
                className={`p-3 mb-4 rounded-lg border ${theme === "dark" ? "bg-gray-700" : "bg-gray-100"
                  }`}
              >
