        ...
        <div className="space-y-3">
          {dataTradesman.map((event) => (
            ...
            >
              ...
              <p className={`text-center text-blue-700 ${text}`}>
                {event.Position}
              </p>
              <p className={`text-center text-blue-700 ${text}`}>
                {event.Phone_Number}
          ...
          >
            ...
            <div className="ml-auto w-fit mt-5 flex gap-3">
              ...
              <button
                ...
                className={`border rounded-xl  duration-300 cursor-pointer p-2  ${
                  theme === "dark"
                    ? "bg-yellow-500 hover:bg-yellow-700 hover:border text-white"
