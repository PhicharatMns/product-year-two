    ...
    <div className="flex">
      ...
      <div className="flex-1">
        <div className="grid-cols-2 grid gap-10 mx-auto w-fit my-5">
          <div className="border h-120 w-wull rounded-xl flex items-center justify-center text-center relative hover:scale-101 duration-300">
            <img
        ...
        <div className="grid grid-cols-2 gap-10 mx-auto w-fit my-5">
          <div className=" h-100 w-full grid grid-cols-2 gap-5 rounded-xl">
