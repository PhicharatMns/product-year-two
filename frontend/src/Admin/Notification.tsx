export default function Notification() {
  return (
    <div className="p-6 max-w-380 mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-3 mt-5 h-150   ">
        <div className="hover:scale-102 bg-gray-100 duration-200 border-b hover:bg-gray-200">
            <p className=" text-2xl font-bold p-5 ">โปรเจคบ้านจัดสรร <span className="rounded-sm text-sm p-1 bg-red-500 text-white">สำคัญ</span></p>
        ...
        <div className="bg-gray-100 hover:scale-102 duration-200 border-b hover:bg-gray-200">
              <p className="text-2xl font-bold p-5">ซ่อมอาคาร บริษัทกรุงศรี <span className="rounded-sm text-sm p-1 bg-red-500 text-white">สำคัญ</span></p>
            <p className="ml-10">ชายใจซื่อ เจอสร้อยข้อมือทองคำหนัก 1 บาท เก็บไว้รอคืนเจ้าของนานนับเดือน เผยไม่คิดขายแม้ชีวิตลำบาก มีเพียงจักรยานคู่ใจคันเดียว ไม่สะดวกเดินทางไปแจ้งตำรวจ ด้านเจ้าของมอบเงินให้ 3 พัน ตอบแทนน้ำใจ</p>
